...
.method public constructor <init>(Landroid/net/wifi/WifiStateTracker;Landroid/os/Looper;Landroid/os/Handler;)V
    ...
    invoke-static {p1}, Landroid/net/wifi/WifiStateTracker;->access$100(Landroid/net/wifi/WifiStateTracker;)Landroid/content/Context;
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v13, "DhcpHandler: DHCP request succeeded"
    ...
    invoke-static {v9, v12}, Landroid/net/wifi/WifiStateTracker;->access$200(Landroid/net/wifi/WifiStateTracker;I)V
    ...
    const-string v9, "DhcpHandler: DHCP request started"
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiStateTracker;->access$300(Landroid/net/wifi/WifiStateTracker;)Ljava/lang/String;

    move-result-object v9

    iget-object v10, p0, Landroid/net/wifi/WifiStateTracker$DhcpHandler;->this$0:Landroid/net/wifi/WifiStateTracker;

    invoke-static {v10}, Landroid/net/wifi/WifiStateTracker;->access$400(Landroid/net/wifi/WifiStateTracker;)Landroid/net/DhcpInfo;
    ...
    const-string v9, "DhcpHandler: DHCP request succeeded"
    ...
    invoke-static {v9, v8}, Landroid/net/wifi/WifiStateTracker;->access$200(Landroid/net/wifi/WifiStateTracker;I)V
    ...
    .line 2614
    iget-object v9, p0, Landroid/net/wifi/WifiStateTracker$DhcpHandler;->mTarget:Landroid/os/Handler;
    ...
    const-string v10, "DhcpHandler: DHCP request failed: "
    ...
    .line 2619
    .end local v0           #event:I
    .end local v1           #modifiedBluetoothCoexistenceMode:Z
    .end local v8           #powerMode:I
    :pswitch_1
    monitor-enter p0
    ...
    invoke-static {v9}, Landroid/net/wifi/WifiStateTracker;->access$400(Landroid/net/wifi/WifiStateTracker;)Landroid/net/DhcpInfo;
    ...
    iget v2, v9, Landroid/net/DhcpInfo;->serverAddress:I

    .line 2629
    .local v2, oAddr:I
    const-string v9, "WifiStateTracker"

    const-string v9, "DhcpHandler: DHCP populate request started"
    ...
    invoke-static {v9, v10}, Landroid/net/NetworkUtils;->populateDhcp(Ljava/lang/String;Landroid/net/DhcpInfo;)Z
    ...
    iget v9, v9, Landroid/net/DhcpInfo;->serverAddress:I
    ...
    .line 2622
    .end local v2           #oAddr:I
    .end local v3           #oDns1:I
    .end local v4           #oDns2:I
    .end local v5           #oGw:I
    .end local v6           #oIp:I
    .end local v7           #oMsk:I
    :catchall_3
    ...
    .line 2645
    .restart local v2       #oAddr:I
    .restart local v3       #oDns1:I
    .restart local v4       #oDns2:I
    .restart local v5       #oGw:I
    .restart local v6       #oIp:I
    .restart local v7       #oMsk:I
    :cond_9
    const-string v9, "WifiStateTracker"
    ...
    const-string v10, "DhcpHandler: DHCP populate request failed: "
